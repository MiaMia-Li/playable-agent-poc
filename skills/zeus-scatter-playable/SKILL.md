---
name: zeus-scatter-playable
description: Adapt and validate the 宙斯 Scatter 转轴 standalone playable template and its published revisions.
---

# 宙斯 Scatter 转轴

Use this skill only for `sourceTemplateId: zeus_scatter`. The platform selects this
...
`references/templates/zeus_scatter.md`. Read it together with the shared delivery guide
