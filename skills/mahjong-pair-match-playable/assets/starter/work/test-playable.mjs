...
globalThis.window=globalThis;globalThis.document={getElementById:id=>elements[id]};globalThis.performance={now:()=>simTime};
...
globalThis.Audio=class{constructor(src){this.src=src;this.loop=false;this.volume=1;this.muted=false}play(){return Promise.resolve()}};
