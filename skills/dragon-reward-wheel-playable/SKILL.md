---
name: dragon-reward-wheel-playable
description: Adapt and validate the 金龙转盘集奖 standalone playable template and its published revisions.
---

# 金龙转盘集奖

Use this skill only for `sourceTemplateId: dragon_reward_wheel`. The platform selects this
...
`references/templates/dragon_reward_wheel.md`. Read it together with the shared delivery guide
